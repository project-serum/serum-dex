...
/// Errors that may be returned by the TokenEtf program.
...
pub enum EtfError {
    ...
    InvalidDelegate,
    /// The token etf state is invalid.
    #[error("InvalidState")]
    InvalidState,
    /// The input token is invalid for etf.
    #[error("InvalidInput")]
    InvalidInput,
    /// The output token is invalid for etf.
    #[error("InvalidOutput")]
    InvalidOutput,
