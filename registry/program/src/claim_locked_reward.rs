...
pub fn handler(
    ...
    let vendor_signer_acc_info = next_account_info(acc_infos)?;
    ...
    let AccessControlResponse { ref vendor } = access_control(AccessControlRequest {
        program_id,
        registrar_acc_info,
        member_acc_info,
        vendor_acc_info,
...
fn access_control(req: AccessControlRequest) -> Result<AccessControlResponse, RegistryError> {
    ...
    Ok(AccessControlResponse { vendor })
}
    ...
    let ix = {
        ...
        Instruction {
            ...
            accounts: vec![
                ...
                AccountMeta::new_readonly(*vendor_signer_acc_info.key, true),
...
struct StateTransitionRequest<'a, 'b, 'c> {
    ...
    registrar_acc_info: &'a AccountInfo<'b>,
    vendor_acc_info: &'a AccountInfo<'b>,
    vendor_signer_acc_info: &'a AccountInfo<'b>,
